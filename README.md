...
#### NOTE:
On windows using Clion, for the program to run go to Project_Name\libraries\curl\bin, find and copy libcurl-x64.dll and paste into cmake-build-debug and rename it to libcurl 
##### Running the program
